<div id="dialog-message" title="Easter egg time!" style=" display : none;">
    <p id="dialogTitle">
        <span class="ui-icon ui-icon-unlocked" style="float:left; margin:0 7px 50px 0;"></span>
        Easter Egg Sbloccato!
        <span class="ui-icon ui-icon-unlocked" style="float:right; margin:0 7px 50px 0;"></span>
    </p>
